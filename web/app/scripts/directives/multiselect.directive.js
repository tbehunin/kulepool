...
module.exports = ['$filter', '$document', '$log', function ($filter, $document, $log) {
    return {
        restrict: 'AE',
        scope: {
            options: '=',
        ...
        link: function ($scope, $element, $attrs, $ngModelCtrl) {
            ...
            $scope.getId = function (item) {
                if (angular.isString(item)) {
                    ...
                    if ($scope.idProp) {
                        return getRecursiveProperty(item, $scope.idProp);
                    } else {
            ...
            $scope.getDisplay = function (item) {
                if (angular.isString(item)) {
                    ...
                    if ($scope.displayProp) {
                        return getRecursiveProperty(item, $scope.displayProp);
                    } else {
